...
const Benefits: React.FC = () => {
  ...
  return (
    <section id="products" className="mt-24">
      ...
      <div className="flex flex-col gap-16 max-w-6xl mx-auto px-5">
        {filteredBenefits.map((product, index) => (
          <div
            key={index}
            onClick={() => setActiveProduct(product)}
            className="grid md:grid-cols-2 gap-10 items-center cursor-pointer border-b border-gray-200 pb-10"
          >
            ...
            <div>
              ...
              <button className="mt-4 text-sm uppercase tracking-widest text-black border-b border-black hover:opacity-70 transition">
                View Details
              </button>
            </div>
